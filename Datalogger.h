...
public:
    ...
    {
        char buf[16];
        /* EDIT REMOVED n which is PID NAME
        byte n = translatePIDName(pid, buf);
        */
        //EDIT BELOW ORIGINAL: byte len = sprintf(buf + n, "%d", value) + n; DONT FORGET COMMA AFTER D
    ...
    //EDIT BELOW nextline and headers
    void nextLine()
    {
        sdfile.println();
    }
    void headers()
    {
        /*sdfile.print("Today's Date: ");
        sdfile.println();*/
        sdfile.print("JARC - OBD-II Data Logging File");
        sdfile.println();
        sdfile.print("Time");
        sdfile.print(",");
        ...
        sdfile.print("RPM");
        sdfile.print(",");
        sdfile.print("Car Speed");
        sdfile.print(",");
        sdfile.print("Throttle");
        sdfile.print(",");
        sdfile.print("Engine Load");
        sdfile.println();
    }
#endif
    uint32_t dataTime;
